        ...
        <div class="col-sm-12">
          <div class="hero-wrapper v-center">
            ...
            <div data-animation-direction="fade" data-animation-delay="1000">
              <a href="#rsvp" class="btn btn-light">RSVP</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="about-us-desc col-lg-8 offset-lg-2" data-animation-direction="from-bottom" data-animation-delay="300">
          ...
          <p>
            We are overjoyed to share the news of our upcoming wedding! It is with immense happiness that we, Andrew and Prachita, invite
        ...
        <div class="col-lg-12 col-xl-10 offset-xl-1">
          <div class="map-info-container">
            <div class="info-wrapper" data-animation-direction="from-bottom" data-animation-delay="100">
              <div class="location-info">
                <div class="neela-style">
                  <h4 class="has-icon"><i class="icon-big-church" />Ceremony<small>03:00pm</small></h4>
                  <h5>Birchwood Church</h5>
                  <p>4181 Birchwood Ave Seal Beach, CA<br />33.776825, -118.059113</p>

                  <div class="info-map-divider" />

                  <h4 class="has-icon"><i class="icon-champagne-glasses" />Reception<small>05:30pm</small></h4>
            ...
            <div class="map-wrapper" data-animation-direction="fade" data-animation-delay="100">
              ...
              <div class="map_pins">
                <ul class="pins">
                  <li><i class="fas fa-bell" />Ceremony</li>
                  <li><i class="fas fa-glass-cheers" />Reception</li>
                  <li><i class="fas fa-bed" />Accomodations</li>
                  <li><i class="fas fa-plane" />Transportation</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-8 col-xl-6">
          ...
          <div class="section-desc">
            ...
            for those who are interested. If you're traveling to celebrate with us, please remember that your presence is the most cherished
            gift we could ever hope for. Thank you for sharing in our special day and for your love and support!
          </div>
        </div>
      </div>
        ...
        <div class="col-md-8 col-xl-6">
          <ul class="wedding-gifts">
            <li id="gift-list" data-animation-direction="from-bottom" data-animation-delay="300">
              <div class="neela-style">
                <i class="icon-wedding" />
                <h3>Check our<br />wedding gift list</h3>

                <div class="info">
                  <a href="https://www.zola.com/registry/manemeetscraswell" class="img" target="_blank" rel="noreferrer">
                    <div style="width: 100px; margin:0 auto;">
                      <svg data-name="Zola Logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1831.769 280.914"
                        ><title id="ZoloLogomarkTitle">Zola logo</title><path
        ...
        <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2  col-xxl-6 offset-xxl-3">
          <div class="form-wrapper flowers neela-style">
            ...
            <form id="form-rsvp" method="post" action="#">
              ...
              <div class="form-floating">
                <textarea id="message" name="Message" placeholder="Message" class="form-control" rows="4" />
